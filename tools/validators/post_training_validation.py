...
class PostTrainingValidator:
    ...
    def __init__(self):
        ...
        self.log_file = Path(
            f"audit_2024/logs/post_training_validation_{self.session_id}.jsonl"
        )
    ...
    def validate_adapter_integrity(self, adapter_path):
        ...
        self.log_validation(
            "VALIDANDO INTEGRIDAD TÉCNICA", {"adapter": str(adapter_path)}
        )
        ...
        try:
            ...
            integrity_results["technical_checks"][
                "config_exists"
            ] = config_file.exists()
            ...
            if not config_file.exists():
                integrity_results["recommendations"].append(
                    "Falta archivo adapter_config.json"
                )
            ...
            integrity_results["technical_checks"]["model_size_mb"] = (
            ...
            try:
                ...
                integrity_results["technical_checks"]["config_size"] = len(
                    json.dumps(config)
                )
            ...
            if integrity_results["is_valid"]:
                integrity_results["recommendations"].append(
                    "Adaptador válido y listo para uso"
                )
            else:
                integrity_results["recommendations"].append(
                    "Adaptador necesita corrección"
                )
    ...
    def validate_all_retrained_adapters(self):
        ...
        for adapter_dir in retraining_dir.iterdir():
            if adapter_dir.is_dir():
                ...
                print(
                    f"  {status} {branch_name}: {score}/{integrity_result['max_score']} puntos"
                )
        ...
        report = {
            ...
            "summary": {
                ...
                "validation_success_rate": (
                    valid_adapters / total_adapters * 100 if total_adapters > 0 else 0
                ),
