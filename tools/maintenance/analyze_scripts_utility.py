    ...
    categories = {
        "ÚTILES_DIARIO": {
            ...
            "scripts": [
                ...
                (
                    "ci_pipeline.sh",
                    "Pipeline CI/CD - útil para validar antes de commits",
                ),
        ...
        "DESARROLLO_AVANZADO": {
            ...
            "scripts": [
                (
                    ...
                    "Features ML avanzadas - solo si desarrollas ML",
                ),
                (
                    "advanced_optimization.py",
                    "Optimizaciones avanzadas - solo si optimizas",
                ),
                ("analyze_dead_code.py", "Análisis código muerto - mantenimiento"),
                ("apply_code_standards.sh", "Aplicar estándares - mantenimiento"),
                (
                    "enterprise_blue_green_deployment.py",
                    "Deployment enterprise - solo en producción",
                ),
            ],
        },
        "SERVIDORES": {
