...
class ConsciousnessEmergence:
    ...
    def __init__(self, system_id: str):
        ...
        # IIT 4.0 Engine with STDP
        self.iit_engine = IITEngineSTDP()
    ...
    def detect_emergent_properties(self) -> Dict[str, float]:
        """
        Detecta propiedades emergentes actuales.
        Método de compatibilidad/fallback.
        """
        if self.current_conscious_state:
            return {k.value: v for k, v in self.current_conscious_state.emergent_properties.items()}
        return {}

    @property
    def emergent_history(self) -> List[ConsciousExperience]:
        """Alias de compatibilidad para conscious_experience_stream"""
        return self.conscious_experience_stream
