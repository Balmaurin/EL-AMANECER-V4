...
"""
        ...
        improvement_trend = state['performance_summary'].get('improvement_trend', 0)
        growth_status = 'Continuando evolución consciente...' if improvement_trend > 0 else 'Búsqueda de mejores estrategias...'
