...
class ImprovedCPUTrainer:
    ...
    def __init__(
        self, num_epochs: int = 3, learning_rate: float = 2e-5, batch_size: int = 4
    ):
        """
    ...
    def train(self) -> Dict[str, Any]:
        ...
        for epoch in range(self.num_epochs):
            ...
            time.sleep(
                min(2.0, base_time / 3 + time_variation / 2)
            )  # Tiempo reducido para demo
    ...
    def get_metrics_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "convergence": {
                "achieved": losses[-1] < losses[0] * 0.5,
                "rate": round(self.convergence_rate, 3),
            },
        }
