...
try:
    ...
    logger.info("✅ Usando LangFuse real")
except ImportError:
    USE_REAL_LANGFUSE = False
    logger.warning("⚠️ LangFuse no instalado, usando stub")


def log_model_inference(
    model: str, prompt: str, completion: str, metadata: Dict = None
) -> str:
    """
...
def _log_with_real_langfuse(
    ...
    trace = langfuse_client.trace(
        name="model-inference", id=trace_id, metadata=metadata or {}
    )
