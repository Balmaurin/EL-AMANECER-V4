...
class RAGServiceClient:
    ...
    def process_corpus(
        self, corpus_path: str, domains: Optional[List[str]] = None
    ) -> Dict:
...
def initialize_rag_service(base_url: str = "http://localhost:8000") -> bool:
    """
...
def retrieve_relevant_memories(
    query: str, branch_name: str = None, max_results: int = 5
) -> List[Dict]:
    """
