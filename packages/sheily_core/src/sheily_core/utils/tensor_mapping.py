...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.DENSE_2_OUT: ("dense_2_out",),  # embeddinggemma
        MODEL_TENSOR.DENSE_3_OUT: ("dense_3_out",),  # embeddinggemma
        # Output norm
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_SINKS: ("model.layers.{bid}.self_attn.sinks",),  # openai-moe
        # Feed-forward norm
        ...
        MODEL_TENSOR.PER_LAYER_TOKEN_EMBD: ("model.embed_tokens_per_layer",),  # gemma3n
        ...
        MODEL_TENSOR.ALTUP_PROJ: ("model.altup_projections",),  # gemma3n
        ...
        MODEL_TENSOR.LAUREL_L: ("model.layers.{bid}.laurel.linear_left",),  # gemma3n
        MODEL_TENSOR.LAUREL_R: ("model.layers.{bid}.laurel.linear_right",),  # gemma3n
        ...
        ),  # tensor generated from resampler.attn.in_proj
        ...
        ),  # for pixtral, this is a generated vector
        MODEL_TENSOR.V_MM_PATCH_MERGER: (
            "multi_modal_projector.patch_merger.merging_layer",  # mistral small 3.1 - hf
            "patch_merger.merging_layer",  # mistral
        ),
        # audio (mtmd)
        MODEL_TENSOR.A_ENC_EMBD_POS: ("audio_tower.embed_positions",),  # ultravox
        MODEL_TENSOR.A_ENC_CONV1D: ("audio_tower.conv{bid}",),  # ultravox
        ...
        MODEL_TENSOR.A_ENC_FFN_DOWN: ("audio_tower.layers.{bid}.fc2",),  # ultravox
        ...
        MODEL_TENSOR.A_MM_NORM_PRE: ("audio.multi_modal_projector.ln_pre",),  # ultravox
        MODEL_TENSOR.A_MM_NORM_MID: ("audio.multi_modal_projector.ln_mid",),  # ultravox
        # NextN/MTP tensors for GLM4_MOE
        MODEL_TENSOR.NEXTN_EH_PROJ: ("model.layers.{bid}.eh_proj",),
        MODEL_TENSOR.NEXTN_EMBED_TOKENS: ("model.layers.{bid}.embed_tokens",),
        MODEL_TENSOR.NEXTN_ENORM: ("model.layers.{bid}.enorm",),
        MODEL_TENSOR.NEXTN_HNORM: ("model.layers.{bid}.hnorm",),
        MODEL_TENSOR.NEXTN_SHARED_HEAD_HEAD: ("model.layers.{bid}.shared_head.head",),
        MODEL_TENSOR.NEXTN_SHARED_HEAD_NORM: ("model.layers.{bid}.shared_head.norm",),
    }
