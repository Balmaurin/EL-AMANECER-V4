...
def save_gbnf_grammar_and_documentation(
    ...
    try:
        ...
        logger.info(f"Grammar successfully saved to {grammar_file_path}")
    except IOError as e:
        logger.error(f"An error occurred while saving the grammar file: {e}")
    try:
        with open(documentation_file_path, "w") as file:
            file.write(documentation)
        logger.info(f"Documentation successfully saved to {documentation_file_path}")
    except IOError as e:
        logger.error(f"An error occurred while saving the documentation file: {e}")
