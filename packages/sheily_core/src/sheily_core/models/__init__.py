...
try:
    ...
    logger.info(f"Advertencia: Algunos componentes de models no disponibles: {e}")
...
def initialize_models_system():
    ...
    logger.info("🚀 Inicializando sistema de modelos Sheily...")
    try:
        ...
        logger.info("✅ Sistema de modelos inicializado correctamente")
        return True

    except Exception as e:
        logger.error(f"❌ Error inicializando sistema de modelos: {e}")
        return False
