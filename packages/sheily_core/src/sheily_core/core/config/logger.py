...
def log_info(
    message: str, component: str = "system", operation: str = "info", **metadata
):
...
def log_warning(
    message: str, component: str = "system", operation: str = "warning", **metadata
):
...
def log_error(
    message: str, component: str = "system", operation: str = "error", **metadata
):
...
def log_debug(
    message: str, component: str = "system", operation: str = "debug", **metadata
):
...
def log_critical(
    message: str, component: str = "system", operation: str = "critical", **metadata
):
...
class EnterpriseLogContext:
    ...
    def __enter__(self):
        self.context = create_log_context(
            self.component, self.operation, metadata=self.metadata
        )
