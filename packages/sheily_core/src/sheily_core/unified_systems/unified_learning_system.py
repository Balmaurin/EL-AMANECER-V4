...
def main():
    ...
    # Consultar base de conocimiento
    logger.info("Consulta de base de conocimiento:")
    ...
    for dominio in dominios_a_consultar:
        ...
        for resultado in resultados:
            logger.info(f"Entrada: {resultado['input_text']}")
            logger.info(f"Respuesta: {resultado['target_text']}")
            logger.info(f"Calidad: {resultado['quality_score']}\n")
    # Obtener resumen de rendimiento
