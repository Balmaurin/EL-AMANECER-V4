        ...
        for step in self._steps:
            ...
            try:
                ...
                error = SheilyError(
                    ...
                    severity=ErrorSeverity.HIGH,
                    context=ErrorContext(
                        component="async_pipeline", operation="execute"
                    ),
                    cause=e,
                )
            ...
            for attempt in range(max_attempts):
                try:
                    ...
                    last_error = SheilyError(
                        ...
                        severity=ErrorSeverity.MEDIUM,
                        context=ErrorContext(
                            component="retry", operation=func.__name__
                        ),
                        cause=e,
                    )
...
async def async_pipeline(
    *funcs: Callable,
) -> Callable[[T], Awaitable["AsyncSafePipeline"]]:
...
logger.info(
    "✅ Utilidades funcionales para composición segura de operaciones cargadas exitosamente"
)
